        ...
        <div
                ...
                <a href="#" class="flex-shrink-0 group block">
                    <div class="flex items-top">
                        <div>
                            ...
                            @if (isset($tweet->user->media) && $tweet->user->media != null)
                        ...
                        <div class="ml-3">
                            <p class="flex items-center text-base leading-6 font-medium text-gray-800 dark:text-white">
                                @if (isset($tweet->user) && $tweet->user != null)
                                    {{ $tweet->user->name }}
                                @endif
            ...
            <div class="pl-16">
                ...
                <div class="flex my-3 mr-2 rounded-2xl border border-gray-600">
                    @if (isset($tweet->media) && $tweet->media != null)
                ...
                <div class="flex">
                    <div class="w-full">
                        <div class="flex items-center">
                            @if (isset($tweet->id) && $tweet->id != null)
                                <!--- favourite --->
                                <div
