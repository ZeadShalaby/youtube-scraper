...
<a class="flex my-2 justify-center xl:justify-start" href="#">
    <svg viewBox="0 0 24 24" class="w-8 h-8 text-blue-400 dark:text-white" fill="currentColor">
        <g>
            <path
...
<nav class="mt-5">
    <a href="{{ route('tweets.index') }}"
        ...
        <span class="hidden xl:block ml-4 font-bold text-md">Tweets</span>
    </a>
    ...
    <a href="{{ route('trashindex') }}"
        class="flex items-center justify-center xl:justify-start text-gray-800 dark:text-white hover:text-blue-400 dark:hover:text-blue-400 mb-8 transition duration-350 ease-in-out">
        <svg fill="currentColor" viewBox="0 0 24 24" class="h-6 w-6">
            <g>
                <!-- Trash can body -->
                <path
                    d="M3 6h18v2H3V6zm2 0h14v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6zm4 3v9h2V9H9zm4 0v9h2V9h-2zM8 4V3h8v1h5v2H3V4h5z" />
            </g>
        </svg>

        <span class="hidden xl:block ml-4 font-bold text-md">Trash</span>
    </a>
