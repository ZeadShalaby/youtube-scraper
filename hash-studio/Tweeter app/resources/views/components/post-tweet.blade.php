    ...
    <form action="{{ route('tweets.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="flex flex-shrink-0 p-4 pb-0">
            <div class="w-12 flex items-top">
                ...
                <img class="inline-block h-10 w-10 rounded-full" src="{{ $mediaUrl }}" alt="profile" />
            </div>
        ...
        <div class="w-full flex items-top p-2 text-white pl-14">
            ...
            <a href="#"class="text-blue-400 hover:bg-blue-50 dark:hover:bg-dim-800 rounded-full p-2">
                ...
                <label for="file-upload" style="cursor: pointer; border: none; background: none;">
                    <input id="file-upload" class="form-control-file" type="file" accept="image/*" name="path"
            ...
            <a href="#" class="text-blue-400 hover:bg-blue-50 dark:hover:bg-dim-800 rounded-full p-2">
                <label for="file-uploads"
                    ...
                    <input id="file-uploads" class="form-control-file" type="file" accept="video/*" name="video"
                        style="width: 10%; display: none">
                    <svg viewBox="0 0 24 24" class="w-5 h-5" fill="currentColor">
                        <g>
                            <path
            ...
            <a href="#" class="text-blue-400 hover:bg-blue-50 dark:hover:bg-dim-800 rounded-full p-2">
                <label for="file-upload"
                    style="cursor: pointer; display: inline-block; border: none; background: none;">
                    {{-- <input id="file-upload" class="form-control-file" type="file"
                                        accept="image/*" name="path" style="display: none;"> --}}
