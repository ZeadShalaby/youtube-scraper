                            ...
                            <div class="hero-form field field-grouped">
                                ...
                                <div class="control">
                                    <a class="button button-primary button-block"
                                        href="{{ route('loginindex') }}">Login</a>
                                </div>
                                <div class="control">
                                    <a class="button button-primary button-block"
                                        href="{{ route('registerIndex') }}">Regist</a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <g fill="none" fill-rule="evenodd">
                                        ...
                                        <g class="anime-element fadeleft-animation">
                                            ...
                                            <g transform="translate(396 157)">
                                                ...
                                                <rect fill="#D2DAF0" x="28" y="20" width="24" height="4"
                                                    rx="2" />
                                            </g>
                                            <g>
                                        ...
                                        <g class="anime-element fadeleft-animation">
                                            <g transform="translate(56 157)">
                                                ...
                                                <rect fill="#D2DAF0" x="28" y="20" width="24" height="4"
                                                    rx="2" />
                                                <rect fill="#ABABC9" x="28" y="216" width="64" height="4"
                                                    rx="2" />
                                                <rect fill="#D2DAF0" x="256" y="216" width="24" height="4"
                                                    rx="2" />
                                                <rect fill="#D2DAF0" x="64" y="20" width="24" height="4"
                                                    rx="2" />
                        ...
                        <div class="testimonials-wrap">
                                ...
                                <div class="testimonial-inner">
                                    <div class="testimonial-main">
                                        <div class="testimonial-header">
                                            <img class="mb-16" src="dist/images/testimonial-01.png"
                                                alt="Testimonial">
                                        </div>
                            ...
                            <div class="testimonial text-xs is-revealing">
                                <div class="testimonial-inner">
                                    <div class="testimonial-main">
                                        <div class="testimonial-header">
                                            <img class="mb-16" src="dist/images/testimonial-02.png"
                                                alt="Testimonial">
                                        </div>
                                        <div class="testimonial-body">
                                            <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                            ...
                            <div class="testimonial text-xs is-revealing">
                                <div class="testimonial-inner">
                                    <div class="testimonial-main">
                                        <div class="testimonial-header">
                                            <img class="mb-16" src="dist/images/testimonial-03.png"
                                                alt="Testimonial">
                                        </div>
                                        <div class="testimonial-body">
                                            <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
